  ...
  useEffect(() => {
    ...
    try {
      ...
      if (registrationMethod === 'phone') {
        // For phone registration, create account with generated email and store phone number
        // Generate email for phone-based accounts
      ...
      if (registrationMethod === 'email') {
        ...
        userData.email = firebaseUser.email; // Store email for reference
      }
